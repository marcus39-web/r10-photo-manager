...
namespace R10CSharp.Pages
{
    public partial class SearchPage : Page
    {
        ...
        public SearchPage()
        {
            ...
            {
                // Falls keine Kategorien im Index gesetzt sind, als Fallback einen Platzhalter einfügen
            ...
            if (rawOrJpg.Count != 0)
            {
                ...
                if (rawOrJpg.Contains("JPG")) RawJpgFilter.SelectedItem = "JPG";
            }
            ...
            // Ordner-Auswahl: direkte Unterordner-Namen unter Canon_R10_Bilder (z.B. 01_Bibiothek_JPG)
            var folders = _index
            ...
            {
                FolderFilter.ItemsSource = new List<string> { "(keiner)" };
                FolderFilter.SelectedIndex = 0;
            }

            // Debug: Log what was loaded into the filters to Data/app_error_log.txt
            try
            {
